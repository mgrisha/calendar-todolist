...
const PopupEvent = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (editId.length) {
      ...
      await axios.put(
        `https://db48fe38d086e78d.mokky.dev/todos/${editId}`,
        findItem,
        {
      ...
      await axios.post("https://db48fe38d086e78d.mokky.dev/todos", newItem, {
        headers: { "Content-Type": "application/json" },
      });
  ...
  const titleForm = eventItem.id.length ? "Edit" : "Add new";

  return (
    <div
      className={clsx(
        styles["popup-event__overlay"],
        popupEvent && styles["active"]
      )}
      id="popupOverlay"
    >
      <div className={styles["popup-event"]} id="popup" ref={popupRef}>
        <div className={styles["popup-event__content"]}>
          <div className={styles["content"]}>
            <div className={styles["content-title"]}>{titleForm} item idea</div>
            <span
              className={styles["popup-event__close"]}
              id="closePopup"
          ...
          <form
            className={styles["popup-event__form"]}
          ...
          >
            ...
            <div className={styles["form-item"]}>
              ...
              <textarea
                className={styles["form-item__textarea"]}
                row="5"
